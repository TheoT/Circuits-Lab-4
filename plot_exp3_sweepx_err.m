...
loglog(I_x_src, I_x_src*10*3,'k','linewidth',2)

xlim([10^-7 max(I_x_src)])
legend('500 nA experimental','500 nA theoretical','5 uA experimental','5 uA theoretical','50 uA experimental','50 uA theoretical','linear error fit','location','northwest')
xlabel 'I_x (Amps)'
ylabel 'I_z (Amps)'
title('Translinear Circuit 2, Sweeping I_x', 'fontsize',20)
saveas(gcf, 'exp3_sweepx_err.png')